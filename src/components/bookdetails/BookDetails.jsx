    ...
    <main className="container">
      <div className="form-wrapper">
        ...
        <div className="divdescription">
          <p>Na album "Był sobie Gdańsk" złożyły się zdjęcia z wielu zbiorów archiwalnych, muzealnych i prywatnych. Przejrzeliśmy ich tysiące. Naszym zamiarem było pokazanie przede wszystkim tych fragmentów miasta, które zniknęły bezpowrotnie lub zmieniły swój charakter.</p>
        </div>
      </div>
    </main>
  );
